...
def show_frame(data, event, apa, tag) :
  ...
  # plt.imshow(frame_ma, cmap="seismic", interpolation="none"
...
if __name__ == '__main__':
  ...
  # data = h5py.File('mu-prolonged-v-100-events/g4-rec-%d.h5'%apa, 'r')
  # data = h5py.File('data-10-event-mp23/data-%d.h5'%apa, 'r')
